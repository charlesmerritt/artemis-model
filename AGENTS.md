...
1. A LETO pipeline initializes state
...
Automated quality gauntlets to generate code, a specifier subagent defines requirements of the code, a coder subagent implements that spec, a cleaner fixes mess and reduces unnecessary complexity, and a hardener which runs mutation testing.
