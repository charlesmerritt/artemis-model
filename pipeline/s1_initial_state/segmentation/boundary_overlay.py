...
Usage:
    uv run python -m pipeline.s1_initial_state.segmentation.boundary_overlay --county-fips 125
    uv run python -m pipeline.s1_initial_state.segmentation.boundary_overlay --pilot-five-county
    uv run python -m pipeline.s1_initial_state.segmentation.boundary_overlay --all-florida
"""
